...
/*                                                                            */
/*                                                        :::      ::::::::   */
/*   parser_special_redirect_append.c                   :+:      :+:    :+:   */
/*                                                    +:+ +:+         +:+     */
...
void	parser_special_redirect_append_more(t_parser *parser, t_token *token,
		int fd)
{
...
void	parser_special_redirect_append(t_parser *parser)
{
	...
	parser_special_redirect_append_more(parser, token, fd);
}
