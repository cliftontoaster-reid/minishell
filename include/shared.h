...
/// @brief Check if the environment variable is set
/// @param key The key of the environment variable
/// @return true if the environment variable is set, false otherwise
bool isenv(const char *key);
...
typedef struct s_command {
  ...
  ///
  /// @note Functions like `is_builtin`, `has_input_redirect`, etc. will use these flags to determine
  /// 
